...
const RegisterForm = () => {
  ...
  const environment  = process.env.REACT_APP_NODE;
  ...
  const RegisterSchema = Yup.object().shape({
    firstName: Yup.string()
      ...
      .when([], {
        ...
        then: Yup.string().max(16, "First Name cannot be more than 16 characters long"),
      })
    ...
    lastName: Yup.string()
      ...
      .when([], {
        is: () => environment === 'production',
        then: Yup.string().max(16, "Last Name cannot be more than 16 characters long"),
      })
      .matches(/^[a-zA-Z]+$/, "Name can only contain alphabets"),
    ...
    email: Yup.string()
      ...
      .email("Invalid Email")
      .matches(/^[a-zA-Z0-9._%+-]+@students.kcau\.ac\.ke$/, "Email must be from students.kcaukcau.ac.ke"),
    ...
    password: Yup.string()
      ...
      .when([], {
        is: () => environment === 'production',
        then: Yup.string().max(16, "Password cannot be more that 16 characters"),
      })
